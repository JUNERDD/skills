...
export const SKILLS: SkillDetail[] = [
  ...
  },
  {
    ...
    workflow: [
      ...
      "Instrument shared causal cuts and invariants, pass compile, collector, expected-probe, and lossless transport-prefix gates, then check that collector recording is live, run `resume-recording` when necessary, and copy the normalized `dashboard-status` line before every user-owned reproduction.",

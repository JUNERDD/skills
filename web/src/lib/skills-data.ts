...
export const SKILLS: SkillDetail[] = [
  ...
  },
  {
    ...
    workflow: [
      ...
      "Start or attach a logging session; browser-capable local startup automatically attempts to open and confirm the dashboard, user-owned reproduction never disables it, and only a verified no-local-GUI host opts out.",

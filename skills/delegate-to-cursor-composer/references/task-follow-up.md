...
Use this packet only for bounded findings from upstream review of a prior Cursor run. Do not use it to introduce new product scope or new architecture. Copy the template and replace every placeholder before dispatch.
...
- Prior Cursor model: composer-2.5-fast unless explicitly user-overridden

    ...
    entryPoints: [
      {
        ...
        description: "Evidence-first debugging sequence, one-shot mode, and cleanup requirements.",
      },
      {
        label: "One-shot reference",
        path: "skills/debug/references/one-shot-debugging.md",
        description: "High-coverage probe planning for expensive or flaky reproductions.",
      },
      {
